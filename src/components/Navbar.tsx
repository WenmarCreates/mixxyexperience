    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/30">
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#" className="text-sm font-medium tracking-widest text-foreground/80 hover:text-foreground transition-colors uppercase">
            Home
          </a>
          <a href="#pricing" className="text-sm font-medium tracking-widest text-foreground/80 hover:text-foreground transition-colors uppercase">
            Pricing
          </a>
          <a
            href="#booking"
      ...
      {isOpen && (
        <div className="md:hidden bg-background/95 backdrop-blur-md border-b border-border/30 px-6 pb-4">

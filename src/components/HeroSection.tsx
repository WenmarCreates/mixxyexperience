    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <motion.div
          ...
          <span className="text-sm text-white/80" style={{ fontFamily: "'Fiona Pro', serif" }}>Atlanta's Premier Mobile Bar Experience</span>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-white/80 mb-2 drop-shadow-md" style={{ fontFamily: "'Fiona Pro', serif", fontWeight: 400 }}>
          Welcome to
        </motion.p>
        <motion.h1
          initial={{ opacity: 0, y: 30 }}
        ...
        <motion.p
          ...
          className="text-3xl md:text-5xl text-accent mb-8 drop-shadow-lg" style={{ fontFamily: "'Fiona Pro', serif", fontWeight: 400 }}>
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto leading-relaxed drop-shadow-md" style={{ fontFamily: "'Fiona Pro', serif", fontWeight: 400 }}>
...
 Let’s Get Mixxy!
        ...
        <motion.div
          ...
          <a
            ...
            <span style={{ fontFamily: "'Fiona Pro', serif" }}>View Pricing</span> <ArrowRight size={18} />
          </a>
          <a
            href="#booking"
            ...
            <span style={{ fontFamily: "'Fiona Pro', serif" }}>Book Now</span>
          </a>
        </motion.div>
      </div>
    </section>);
